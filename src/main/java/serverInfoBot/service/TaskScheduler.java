...
public class TaskScheduler {
    ...
    @Autowired
    public TaskScheduler(BattlemetricsService battlemetricsService, Configuration configuration, NextLayer nextLayer) {
    ...
    public void startScheduleTaskNextLayer(JDA jda){
